...
export type UpdatePageInput = Partial<Omit<CreatePageInput, "pageType">>;
...
/** Typed wrappers over the CMS & Publishing Workflow admin endpoints (cms:manage / cms:publish). No new backend routes — mirrors the proven apps/admin client. */
