...
export interface CardProps extends React.HTMLAttributes<HTMLDivElement> {
  /** Compact padding (16px) for dense rail widgets vs. the default 24px for content cards. */
  density?: "default" | "compact";
  /** Adds the hover-lift micro-interaction (used for clickable cards like CourseCard). */
  interactive?: boolean;
}

/** Base surface for every card on the dashboard — 20px radius, hairline border, very soft shadow. */
